    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('condition', models.CharField(choices=[('u', 'Used'), ('n', 'New'), ('r', 'Refurbished')], max_length=1)),
                ...
                ('transmission', models.CharField(choices=[('AT', 'Automatic'), ('MT', 'Manual'), ('AM', 'Automated Manual'), ('CVT', 'Continuosly Variable')], max_length=3)),
